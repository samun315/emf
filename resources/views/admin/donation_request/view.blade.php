...
@section('title', 'Donation Request View')
@section('toolbarTitle', 'Donation Request View')
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="svg-icon svg-icon-2">
                            ...
                            <span class="card-label fw-bolder fs-3 mb-1">Donation Request View</span>
                        </span>
                    </h3>
                ...
                <div class="card-body py-3">
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 fv-row mb-5">
                            <label class="required fs-5 fw-bold mb-2">Project/Program Name</label>
                            <input type="text" class="form-control form-control-solid" disabled
                                   value="{{ $data->project_or_program_name }}"/>
                        </div>
