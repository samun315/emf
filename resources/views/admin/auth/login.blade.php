...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="shortcut icon" href="{{ asset('assets/backend/media/logos/EMF-Final-Logo-footer.png') }}" />
    <!--begin::Fonts-->
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        ...
                        <a href="/admin-login" class="py-9 mb-5">
                            <img alt="Logo" src="{{ asset('assets/backend/media/logos/EMF-Final-Logo-footer.png') }}" class="h-150px" />

                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to Engineer Moqbul Foundation (EMF)</h1>
                        <!--end::Title-->
                        <!--end::Description-->
                    </div>
                    <!--end::Content-->
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark mb-3">Sign In to Engineer Moqbul Foundation (EMF)</h1>
                                <!--end::Title-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group-->
